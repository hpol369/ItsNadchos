 ...
 */
export async function getRandomFreePhoto(mood) {
    let query = supabase
 ...
 */
export function getFreePhotoUrl(storagePath) {
 ...
 */
export function shouldSendFreePhoto(messageCount, lastPhotoSentAt, conversationMood) {
 ...
 */
export function getPhotoCaption(description) {
    const captions = [
...
//# sourceMappingURL=freePhotos.js.map