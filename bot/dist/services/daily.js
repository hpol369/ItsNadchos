 ...
 */
export async function generateDailyMessage(userId, displayName, memories) {
 ...
 */
export async function selectDailyFreePhoto() {
 ...
 */
export async function sendDailyNotification(userId, telegramId) {
 ...
 */
export async function processAllDailyNotifications() {
    const today = new Date().toISOString().split('T')[0];
