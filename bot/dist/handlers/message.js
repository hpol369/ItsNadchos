...
function getCreditFooter(balance, freeRemaining) {
    if (freeRemaining > 0) {
...
async function sendMessage(ctx, response) {
...
export async function handleMessage(ctx) {
    ...
    try {
        ...
        if (!creditCheck.allowed) {
            ...
            await ctx.reply(`you've used your ${FREE_DAILY_MESSAGES} free messages for today 💕\n\nget credits to keep chatting with me!`, {
                reply_markup: {
                    inline_keyboard: [[
